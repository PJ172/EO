...
import {
    Plus, Newspaper, Loader2, Eye, EyeOff, Search, LayoutGrid, List, FileDown, Upload, ArrowUpDown, ChevronUp, ChevronDown, Settings2
} from "lucide-react";
import {
    DropdownMenu,
    DropdownMenuContent,
    ...
    return (
        <div className="flex gap-6 h-[calc(100vh-0rem)] p-2 bg-background custom-scrollbar">
            ...
            <div className="flex-1 space-y-4 overflow-auto">
                ...
                <PageHeader
                    title="TIN TỨC"
                    titleClassName="from-rose-500 to-red-700 dark:from-rose-400 dark:to-red-500"
                    icon={
                        <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl flex items-center justify-center shadow-sm bg-gradient-to-br from-rose-500 to-red-700">
