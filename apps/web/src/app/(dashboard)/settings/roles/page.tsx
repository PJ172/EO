...
import { MoreHorizontal, Plus, Search, Filter, FileDown, ArrowUpDown, ChevronUp, ChevronDown, Trash2, Upload, Grid3X3, LayoutList, BarChart3, Loader2, Info, ShieldCheck, Save, Settings2 } from "lucide-react";
        ...
        <div className="flex flex-col h-[calc(100vh-0rem)] space-y-4 p-2 bg-background">
            <div className="bg-card/60 backdrop-blur-xl border border-border/50 shadow-sm rounded-xl p-2 animate-in fade-in slide-in-from-top-4 duration-500">
                <PageHeader
                    ...
                    titleClassName="from-slate-600 to-slate-800 dark:from-slate-300 dark:to-slate-100"
                    icon={
                    ...
                    <div className="flex items-center gap-2">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-[200px] border-border shadow-lg rounded-xl">
                                ...
                                <DropdownMenuItem onClick={() => setImportOpen(true)} className="py-2.5 cursor-pointer rounded-lg mx-1">
                        ...
                        />
                        <Button onClick={() => router.push('/settings/roles/new')} className="h-9 bg-slate-700 hover:bg-slate-800 text-white shadow-lg shadow-slate-500/20 transition-all hover:-translate-y-0.5 px-5 rounded-xl font-semibold">
