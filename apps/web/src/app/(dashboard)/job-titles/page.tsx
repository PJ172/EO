...
export default function JobTitlesPage() {
    ...
    const handleStatusToggle = async (id: string, currentStatus: string) => {
        try {
            ...
            toast.success(`Đã ${newStatus === "ACTIVE" ? "kích hoạt" : "vô hiệu hóa"} chức vụ`);
            refetch();
        } catch (error: any) {
        ...
        <>
            <OrgModulePage<JobTitle>
                config={{
                    ...
                    singularLabel: "chức vụ",
                    searchPlaceholder: "Tìm kiếm theo mã, tên chức vụ...",
                    backHref: "/settings",
                }}
                ...
                onBulkDelete={async (ids) => {
                    ...
                    if (results.success > 0) toast.success(`Đã xóa ${results.success} chức vụ`);
                    if (results.failed > 0) {
