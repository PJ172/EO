...
export default function TicketsPage() {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-0rem)] space-y-4 p-2 bg-background">
            ...
            <PageHeader
                title="IT TICKET"
                titleClassName="from-orange-500 to-red-600 dark:from-orange-400 dark:to-red-400"
                icon={
                    <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl flex items-center justify-center shadow-sm bg-gradient-to-br from-orange-500 to-red-600">
